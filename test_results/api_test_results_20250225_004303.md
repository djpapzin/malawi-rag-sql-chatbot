...
```json
{
  "response": {
    ...
    "metadata": {
      "total_results": 20,
      "query_time": "0.00s",
      "sql_query": "SELECT * FROM proj_dashboard WHERE LOWER(district) = 'zomba'"
    }
  }
}
```
...
```json
{
  "response": {
    ...
    "metadata": {
      "total_results": 28,
      "query_time": "0.00s",
      "sql_query": "SELECT * FROM proj_dashboard WHERE LOWER(projectsector) = 'infrastructure'"
    }
  }
}
```
