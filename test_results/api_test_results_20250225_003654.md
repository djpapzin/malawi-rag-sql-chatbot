...
```json
{
  "response": {
    ...
    "metadata": {
      "total_results": 196,
      "query_time": "0.00s",
      "sql_query": "SELECT pd.projectname, pd.district, pd.projectsector, pd.projectstatus, pd.budget, pd.completionpercentage\nFROM proj_dashboard pd;"
    }
  }
}
```
...
```json
{
  "response": {
    ...
    "metadata": {
      "total_results": 196,
      "query_time": "0.01s",
      "sql_query": "SELECT projectname, district, projectsector, projectstatus, budget, completionpercentage FROM proj_dashboard "
    }
  }
}
```
